  ...
  async render() {
    ...
    try {
      ...
      candidates.forEach(c => {
        // candidates list endpoint doesn't include skills; use raw info if available
      });
      ...
      view.innerHTML =
        ...
        '<div class="grid">' +
          ...
          '<div class="stat"><div class="label">Shortlisted</div><div class="value">' + shortlisted + '</div></div>' +
        ...
        '<div class="card" style="margin-top:20px;">' +
          ...
          (allResults.length === 0
            ...
            : '<table><thead><tr><th>Candidate</th><th>JD</th><th>Match</th><th>Status</th><th>Location</th></tr></thead><tbody>' +
      ...
      if (ctx1 && typeof Chart !== 'undefined') {
        this.charts.status = new Chart(ctx1, {
          ...
          data: {
            ...
            datasets: [{
              data: [strong, potential, review, low],
      ...
      view.innerHTML = '<div class="card"><p>Please log in to view the dashboard.</p><p class="muted">' + e.message + '</p></div>';
    }
  }
};
